...
const highlights = [
  { icon: Coffee, label: "1.5+ Years", desc: "of experience" },
  { icon: Zap, label: "20+", desc: "projects delivered" },
];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background:
                      "radial-gradient(circle, rgba(252,3,44,0.06) 0%, transparent 70%)",
                    filter: "blur(40px)",
                  }}
                />
                ...
                {/* Code snippet visual */}
                <div
                  className={`rounded-2xl p-5 mb-6 font-mono text-sm ${isDark ? "bg-black/50" : "bg-black/5"}`}
                >
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <span
                      className={`ml-2 text-xs ${isDark ? "text-white/20" : "text-black/30"}`}
                    >
                      developer.js
                    </span>
                  </div>
                  <div className="space-y-1.5">
                    ...
                    <div className="pl-4">
                      ...
                      <span style={{ color: "#22c55e" }}>"Web Developer"</span>
                      <span
                        className={isDark ? " text-white/50" : " text-black/50"}
                      >
                        ,
                ...
                <div className="grid grid-cols-2 gap-3">
                  {highlights.map(({ icon: Icon, label, desc }) => (
                    ...
                    >
                      ...
                      />
                      <div
                        className={`font-display font-bold text-xl ${isDark ? "text-white" : "text-black"}`}
                      >
                        {label}
                      </div>
                      <div
              ...
              >
                ...
                <div
                  className={`text-xs font-body font-medium ${isDark ? "text-white" : "text-black"}`}
                >
                  Always shipping
                </div>
              </motion.div>
          ...
          >
            <motion.div variants={fadeInRight}>
              ...
              <h2
                className={`font-display font-bold text-4xl lg:text-5xl mt-3 leading-tight ${isDark ? "text-white" : "text-black"}`}
              >
                Crafting Digital
                <br />
                <span
            ...
            >
              ...
              with practical experience in WordPress and WooCommerce. I enjoy
              building responsive, scalable, and user-focused web applications
              with clean interfaces and smooth user experiences.
            </motion.p>
            ...
            >
              Currently, I'm strengthening my skills in TypeScript, Redux
              Toolkit, API integration, and modern frontend architecture while
              continuously learning through real-world projects. My goal is to
